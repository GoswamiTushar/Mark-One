...
var rankholders = [{Name : "Tushar",
                    ...
                    {Name : "Joy",
                    Score : 5}] // Scoreboard
var friends = ["Tushar", "Joy"]; //Friends List
var score = 0;

var name = readlineSync.question("What is your name? "); //Players Name
...
function askyourfriend(qsn, options, ans, iteration){
  ...
  console.log(chalk.bgRed.bold.black("Question No ", iteration, "\n"))
...
function main(){
  ...
  console.log("I and Neogcamp welcome you to\n ", chalk.bgYellow.bold.white("How much you know about Tushar? \n"));
